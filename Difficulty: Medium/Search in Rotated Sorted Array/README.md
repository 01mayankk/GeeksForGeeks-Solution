<h2><a href="https://www.geeksforgeeks.org/problems/search-in-a-rotated-array4618/1?page=1&category=Searching,Binary%20Search%20Tree&status=unsolved&sortBy=submissions">Search in Rotated Sorted Array</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a <strong>sorted </strong>and <strong>rotated </strong>array <strong>arr[]</strong> of <strong>distinct </strong>elements, the task is to find the index of a target <strong>key</strong>.&nbsp;</span><span style="font-size: 18px;"> If the key is not present in the array, return <strong>-1</strong>.</span></p>
